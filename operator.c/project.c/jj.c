...
//CODES OF WELCOME &LOGIN CHOICE FUNCTION :
 void main()
{
    clrscr();
    int n;
    while (1)
    {
        ...
        gotoxy(28, 24);
        textcolor(125);
        cprintf("@Copyright,2020 Reserved");
        gotoxy(28, 15);
        textcolor(BROWN);
...
//CODES OF NEW MEMBERS CREATION FUNCTION :
 void Member()
{
    screen();
    FILE *fp;
...
//CODES OF BOOKS RETURN FUNCTION :
 void BReturn()
{
    FILE *fp, *fp1;
    char r[10];
...
//CODES OF MEMBER DISPLAY FUNCTION :
 void Display()
{
    screen();
    int i = 13;
...
//CODES OF ONE MEMBER AT A TIME DISPLAY FUNCTION :
...
//CODES OF NEW BOOKS ENTRY FUNCTION : 
...
//CODES OF SCRAPE ENTRY FUNCTION :
...
//CODES OF REMOVE MEMBERS FUNCTION :
...
//CODES OF BOOKS DISPLAY FUNCTION : 
...
//CODES OF BOOKS DISPLAY BY BID FUNCTION :
...
//CODES OF BOOKS ISSUE SUMMARY FUNCTION : 
...
//CODES OF RETURN BOOK SUMMARY FUNCTION : 
